        ...
        <div class="signUpArea">
          <div class="container">
            <div class="btn-group mt-2 mb-3" role="group">
              <input type="radio" class="btn-check" name="level" id="begginerRadio" checked>
              <label class="btn btn-outline-warning" for="begginerRadio">Begginer</label>

              <input type="radio" class="btn-check" name="level" id="intermediateRadio">
              <label class="btn btn-outline-warning" for="intermediateRadio">Middle</label>

              <input type="radio" class="btn-check" name="level" id="proRadio">
            ...
            <div class="mb-3">
              ...
              <div class="text-danger">{{ $errors->first('userDescribe') }}</div>
            </div>
